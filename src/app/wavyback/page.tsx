...
<button type="button"
              className="sm:  bg-sky-500 rounded-full border-2 hover:bg-sky-600 border-neutral-50 px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-white transition duration-1000 ease-in-out"
              data-te-ripple-init data-te-ripple-color="dark">
  Sign up now
</button>
